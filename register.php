	...
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5 center-text">
					<!-- <h2 class="heading-section">Login #10</h2> -->
                    <a href="index.php" class=" navbar-brand logo center-text"><span><span style="font-size: 45px;">S</span>plit</span><span style="font-size: 45px; color: white;">I</span>t!</a>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
		      	<h3 class="mb-4 text-center">Register for free!</h3>
